...
class PlayerViewController: UIViewController {
    ...
    func configure() {
        ...
        songNameLabel.frame = CGRect(x:10,
                                     y: albumImageView.frame.size.width+10,
                                      width: holder.frame.size.width-20,
                                      height: 70)
        albumNameLabel.frame = CGRect(x:10,
                                      y: albumImageView.frame.size.width+10+70,
                                      width: holder.frame.size.width-20,
                                      height: 70)
        
        artistNameLabel.frame = CGRect(x:10,
                                      y: albumImageView.frame.size.width+10+140,
                                      width: holder.frame.size.width-20,
                                      height: 70)
        ...
        let slider = UISlider(frame: CGRect(x:20,
                                            ...
                                            height:50))
        slider.value = 0.5
        slider.addTarget(self, action: #selector(didSlideSlider(slider:)), for: .valueChanged)
